...
export default function Footer() {
  return (
    <>
        <footer className="container-fluid bg-footer bg-primary text-white mt-5">
        ...
        <div className="container-fluid bg-dark text-white py-4">
            <div className="container text-center">
                <p className="mb-0">&copy; <a className="text-secondary fw-bold" href="#">Agri Market</a>. Tous Droits Réservés.</p>
            </div>
        </div>
